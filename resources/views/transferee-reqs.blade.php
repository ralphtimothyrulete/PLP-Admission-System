<x-layout>
    ...
    <h1 class="text-3xl font-bold text-green-600 mb-1 mt-4 font-poppins text-center md:text-left">STUDENT TRANSFEREE APPLICATION</h1>
    <main class="container mx-auto px-6 py-8">
        ...
        <form method="POST" action="{{ route('transferee.upload') }}" enctype="multipart/form-data" id="transferee-upload-form">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 card-appear">
            <input type="hidden" name="student_id" value="{{ $student_id }}">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg font-poppins">
                    ...
                    <ul class="space-y-4 mt-4 text-black">
                        <li class="border border-green-500 rounded-lg p-4 transition-all hover:bg-green-100">Certified True Copy (CTC) of TOR with remarks</li>
                        ...
                        <li class="border border-green-500 rounded-lg p-4 transition-all hover:bg-green-100">Any Government Issued ID of Parents / Guardian</li>
                        <li class="border border-green-500 rounded-lg p-4 transition-all hover:bg-green-100">Notarized Affidavit of Guardianship (For Applicants with Guardians only)</li>
                    </ul>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg font-poppins card-appear">
                    ...
                    <p class="mb-1"> Add your documents here </p>
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-black mb-3">Uploaded Files</h3>
