...
@section('body')
<a href="{{ route('entrance-exam-results.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">Back to List</a>
<div class="container mx-auto mt-8">
    <div class="bg-white shadow-md rounded-lg p-6">
        <h2 class="text-3xl font-bold text-green-600 mb-2 font-poppins">Create Entrance Exam Result</h2>
        <form action="{{ route('entrance-exam-results.store') }}" method="POST">
            @csrf
            <div class="mb-4">
