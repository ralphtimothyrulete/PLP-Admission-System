...
<div class="flex flex-col mt-5">
    <div class="mb-4 flex items-center justify-between">
        ...
        <form action="{{ route('entrance-exam-results.index') }}" method="GET" class="flex items-center ml-4">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by name or result" class="w-60 p-2 border rounded">
