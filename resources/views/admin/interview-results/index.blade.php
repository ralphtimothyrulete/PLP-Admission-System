...
@section('body')
<h3 class="text-3xl font-bold text-black mb-5">Interview Results</h3>
<a href="{{ route('interview-results.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">Create New Result</a>
<div class="flex flex-col mt-8">
    <div class="mb-4 flex items-center">
        <form action="{{ route('interview-results.upload') }}" method="POST" enctype="multipart/form-data" class="flex items-center">
            @csrf
    ...
    @endif
    <div class="mb-4">
        <form action="{{ route('interview-results.index') }}" method="GET" class="flex items-center">
...
<script>
    function confirmDelete(id) {
        document.getElementById('deleteForm').action = '/interview-results/' + id;
